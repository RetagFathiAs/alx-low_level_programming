 ...
 * @s1: the firing
 * @s2: the seing
 * @n: the max nus to compare
 *
 * Return: 0 if the first n bytes of s1 and s non-zero
 */
...
/**
 * _read - read from a file andon failure
 * @fd: the file desad from
 * @buf: the buffer to write to
 * @count: the numytes to read
 */
